...
public class BankMain {
	...
	public static void main(String[] args) {
		...
		accountArray[1] = new Account("1001", "임스", 10000);
		accountArray[2] = new Account("1002", "스", 10000);
		while (run) {
			System.out.println("--------------------------------------------------");
	...
	private static void createAccount() {
		...
		String ano = "" + (1000 + index); // index: 현재 빈곳을 가리킴
...
//		}
	...
	private static void accountList() {
		...
		for (int i = 0; i < index; i++) {
			...
			System.out.printf("%s %-26s\t%,10d%n", acc.getAno(), acc.getOwer(), acc.getBalance());
		}
	}
