...
public class MelonMain {
	...
	public static void main(String[] args) {
		...
		MelonChart[] melonChartArray = { melonChart, melonChart2,
				new MelonChart(3, "perfect n", "르세라핌", "perfect n", 95252),
				new MelonChart(4, "에피소드", "이무진", "에피소드", 95223), 
				new MelonChart(5, "Drama", "에스파", "Drama", 43252) };
		...
		list.add(new MelonChart(3, "perfect n", "르세라핌", "perfect n", 95252));
		list.add(new MelonChart(4, "에피소드", "이무진", "에피소드", 95223));
		list.add(new MelonChart(5, "Drama", "에스파", "Drama", 43252));
//		for(MelonChart mc: list)
//		System.out.println(mc);
		list.forEach(x -> System.out.println(x)); // -> 람다함수로 출력
	}
